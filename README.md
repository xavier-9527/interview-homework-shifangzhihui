...
## Provided showcase component

We have provided a `MultiCheckShowcase` component in minified bundle in the repo, 
which is a helper component to makes it easy to switch different properties to `MultiCheck`.

You can uncomment in `App.tsx`.
